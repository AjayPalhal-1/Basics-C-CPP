...
int main ()
{
          printf("Total Discount Is = %d ",DiscountCal());      //  Q1 
          printf("Biggest No. Is = %d ",BigNumCal());       //  Q2 
          printf("Calculated Ans Is = %d ", Calculator());       //  Q3 
          printf("Menu Op = %d ",menu());            //   Q4
          printf("Discount For Student Is = %d ",DiscountForStud()); //   Q5 
}
