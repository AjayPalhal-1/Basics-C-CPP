...
#include<stdio.h>
     ...
     float  TempF_2_C(float);              // Q1
     int   Peri_Area_Rectangle (int ,int );   // Q2 A)
     float AreaOfCircle(float,float );           // Q2 B)
     int  reverse(int);                // Q3 
     void EvnOdd (int);                // Q4 
     int  SalCalculator(int);          // Q5
...
int main ()
{    float  C=45;
     printf("Conversion of TempCelsius to Fahrenheit is : %f\n",TempF_2_C(C));   //Q1
...
int Peri_Area_Rectangle (int Len ,int wid)
{
    int area;
    area = Len*wid;
...
float  AreaOfCircle(float rediuse,float pi )
{
